...
# ===============================================
# Internals: Namelist parsing and type conversion
# ===============================================
...
def test_namelist():
    ...
    filestring = """
! some comment outside the block
&myblock
    KTIME = 0         !  real time          | NO         | YES
    REAL_VALUE = 1.2       !  some fake real value for testing
    NYRSR = 1700   	  ! strat time (yrBP "-"). For KTIME=0 permanent year
    RESTART_IN = "INP/restart.dat"  ! input restart file
/
    """
    print("Read fake param file: ")
    print(filestring)

    params = Namelist.parse(filestring)
